...
export default function Contact() {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-[url('/src/assets/img/ameen-almayuf-OQ4tJVXMCYM-unsplash.jpg')] lg:h-[300px] bg-cover bg-center h-64 md:h-80 rounded-lg shadow-sm shadow-black flex items-center justify-center">
