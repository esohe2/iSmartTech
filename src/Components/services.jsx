...
export default function Services() {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-[url('/src/assets/img/seruse.png')]  bg-cover bg-center h-64 md:h-80 rounded-lg shadow-sm shadow-black flex items-center justify-center lg:h-[300px] ">
